  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: '12px', fontWeight: 600, color: colors.textDim, letterSpacing: '0.05em' }}>
          KILL REPORT // {data.targetName.toUpperCase()}
        </span>
      </div>

      {/* Two-column body */}
      <div style={{ display: 'flex', flex: 1, padding: '28px 32px', gap: '32px' }}>
        {/* Left column — roast content */}
        <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 58%', gap: '16px' }}>
          {/* Badges row */}
          ...
          <span
            style={{
              fontSize: data.roastText.length > 200 ? '16px' : '18px',
              lineHeight: 1.6,
              color: colors.text,
              flex: 1,
            }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 38%', gap: '2px' }}>
          <span
            style={{
              fontSize: '10px',
              fontWeight: 700,
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          {avatarDataUrl && (
            <img src={avatarDataUrl} width={24} height={24} style={{ borderRadius: '50%' }} />
          )}
