...
[x] #B-51 — /news pipeline: 5-phase orchestrator (gather → Opus research + Perplexity → parallel Opus+Lightning generation → rankBatch + 5-judge eval → Telegram digest + stockpile). NewsEventRepository, migration 022, monitor accumulator hook (score≥12), story diversity (max 2/story). Shipped 2026-04-02
[x] #B-52 — Daily news thread: formatNewsThread (hook+middles+closer+cashtags), NewsThreadRepository (migration 023), Telegram preview with Schedule/Post Now/Regen buttons, daily 14:00 UTC cron with auto-generate fallback, 45-90s anti-bot delays, TICKER_MAP (40+ tokens), twitterWeightedLength validation. Shipped 2026-04-03
