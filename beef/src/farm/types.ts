...
export type PromptStrategy = 'unified' | 'rubric' | 'persona' | 'adversarial' | 'fast-gen' | 'lightning';
...
// --- Evaluation (re-exported from shared module for backward compatibility) ---

export type { JudgePersona, EvaluationScores, EvaluationResult, JudgeEvaluation } from '@evaluation/types.js';
